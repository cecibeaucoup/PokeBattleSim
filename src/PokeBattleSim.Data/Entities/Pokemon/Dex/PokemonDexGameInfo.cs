...
namespace PokeBattleSim.Data.Entities.Pokemon.Dex
{
    public class PokemonDexGameInfo(IEnumerable<PokeAttribute> _attributes, IEnumerable<PokeSkill> _skills, IEnumerable<MobilityTypes> _mobility, 
                                    IEnumerable<Senses> _senses, IEnumerable<string>? _possibleAbilities = null, IEnumerable<string>? _possibleMoves = null)
    {
        ...
        public IEnumerable<Senses> Senses { get; set; } = _senses;
        ...
        public string ToDex()
        {
            ...
            strBuilder += $"Senses: {string.Join(", ", Senses)}\n\n";
